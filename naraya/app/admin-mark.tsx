  ...
  return (
    <details className="group relative inline-flex shrink-0">
      <summary
        ...
        className="admin-verified-mark inline-flex h-8 w-8 cursor-pointer list-none items-center justify-center rounded-full text-sky-300 outline-none transition hover:bg-sky-400/10 focus-visible:ring-2 focus-visible:ring-sky-300/60 [&::-webkit-details-marker]:hidden"
      >
        <BadgeCheck size={18} strokeWidth={2.4} className="admin-verified-icon" />
      </summary>
